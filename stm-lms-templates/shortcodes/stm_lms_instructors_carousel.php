	...
	<div class="stm_lms_instructors_carousel"
		...
		<?php if ( ! empty( $results ) ) : ?>
			<div class="stm_lms_instructors_carousel__top">
				...
				<div class="stm_lms_instructors_carousel__top--left">
                    <?php if ( ! empty( $title ) ) : ?>
                ...
                <div class="stm_lms_instructors_carousel__top--right">
                    ...
                    <?php endif; ?>
                    <?php if ( 'disable' !== $prev_next && ( 'style_2' === $style || 'style_3' === $style ) ) : ?>
                        <div class="stm_lms_instructors_carousel__buttons">
                            <div class="stm_lms_instructors_carousel__button stm_lms_instructors_carousel__button_prev sbc_h sbrc_h">
                                <i class="fa fa-chevron-left"></i>
                            </div>
                            <div class="stm_lms_instructors_carousel__button stm_lms_instructors_carousel__button_next sbc_h sbrc_h">
						...
						<div class="stm_lms_user_side">
                            ...
                            ?>
                                    <div class="stm-lms-user_avatar">
                                        <?php if ( in_array( $style, array( 'style_1', 'style_2' ) ) ) : ?>
                                            <a href="<?php echo esc_url( $user_profile_url ); ?>">
                                        <?php
                                            endif;

                                            echo wp_kses_post( $user['avatar'] );
                                ...
                                <?php
                                    ...
                                    if ( 'style_3' === $style ) :
                                ?>
                                    <div class="stm-lms-user-info__bottom">
                                <?php endif; ?>
                                ...
                                <?php if ( 'style_3' !== $style && ! empty( $rating['total'] ) && 'style_2' !== $style ) : ?>
