...
wp_enqueue_script('stm-lms-edit_account', STM_THEME_CHILD_DIRECTORY_URI . '/assets/js/edit_account.js', array('vue.js', 'vue-resource.js'), STM_THEME_CHILD_VERSION, true);
