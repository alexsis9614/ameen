...
?>
	<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
		<img class="logo_transparent_static visible" src="<?php echo esc_url($logo); ?>" style="width: <?php echo stm_option( 'logo_width', '246' ); ?>px;" alt="<?php bloginfo( 'name' ); ?>"/>
		<?php if ( $transparent_header ) : ?>
			<img class="logo_colored_fixed hidden" src="<?php echo esc_url($logo_black); ?>" style="width: <?php echo stm_option( 'logo_width', '246' ); ?>px;" alt="<?php bloginfo( 'name' ); ?>"/>
		<?php endif; ?>
	</a>
<?php else: ?>
